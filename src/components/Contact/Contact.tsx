...
const Contact = () => {
  return (
    <div className={styles.contact}>
      ...
      <p>Punete in contact direct cu unul din consultanti nostri 
si te vom ajuta sa iti duci afacerea la urmatorul nivel</p>
...
<p>Facebook</p>
   ...
   <img className={styles.contactLogo} src={contactlogo} alt='logo' />
    ...
    <label>Selecteaza pachetul </label>
        <select>
        <option selected value=".">Select project budget</option>
